...
public static class SetupRTSHUD
{
    ...
    public static void SetupHUD()
    {
        ...
        buildPanel.sizeDelta        = new Vector2(250f, 150f);
        buildPanel.localScale       = Vector3.one;
        buildPanel.gameObject.SetActive(true);
        Debug.Log("[SetupRTSHUD] ✓ BuildPanel created (250x150, bottom-right, offset -25,25)");

        // Buttons: center-anchored inside the BuildPanel.
        //   BtnBarracks    above centre at y = +40
        //   BtnPowerPlant  below centre at y = -25
        ...
        productionPanel.sizeDelta        = new Vector2(250f, 150f);
